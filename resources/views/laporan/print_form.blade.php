...
@section('main')
    <div class="car-body">
        <div class="input-group mb-3">
            ...
            <input type="date" autocomplete="off" name="tglawal" id="tglawal" class="form-control" />
        </div>

        <div class="input-group mb-3">
            <label for="label">Tanggal Akhir</label>
            <input type="date"autocomplete="off" name="tglakhir" id="tglakhir" class="form-control" />
        </div>
